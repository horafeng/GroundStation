...
主界面的“网络与配置...”只显示关键摘要；点击后打开可缩放的独立设置窗口，一级页签为
...
主窗口以地图为中部主要工作区，右侧集中雷达自身、当前目标、五种模式和网络控制；
下方航迹表与日志分别由可拖动的纵向分隔条管理。航迹表不提供“定位当前目标”按钮：选中关系仍
...
地图左下保留视频副视角，可切到视频主视角并恢复地图。视频源当前仅有“未连接”、
