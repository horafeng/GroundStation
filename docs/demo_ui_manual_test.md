...
4. UI应显示雷达经纬度、海拔、卫星数和4条航迹；地图以雷达/Home为中心。
...
8. 地图、航迹表和日志之间可拖动调整；表格应完整填充外框，滚动条贴合表格边界。

## 5. 人工选择、发送和模式

1. 点击地图航迹7或表格航迹7。首次选择直接成功，地图、表格和详情同步高亮。
...
3. 点击视频副视角按钮，视频成为主区、地图成为副视角；再次点击恢复地图主视角。
